...
import { FaPlus,FaMinus,FaStarOfLife,FaDivide } from "react-icons/fa";
const Calculator = () => {
    ...
    return (
      <div className="calculator b-box">
        ...
        <div className="btn">
          ...
          <button className='b' onClick={() => performOperation('multiply')}><FaStarOfLife /></button>
          <button className='b' onClick={() => performOperation('divide')}><FaDivide /></button>
